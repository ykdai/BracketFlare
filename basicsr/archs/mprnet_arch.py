...
class MPRNet(nn.Module):
    def __init__(self, img_ch=3, output_ch=3, n_feat=40, scale_unetfeats=20, scale_orsnetfeats=16, num_cab=8, kernel_size=3, reduction=4, bias=False,**kwargs):
        ...
        self.activation=nn.Sequential(nn.ReLU(inplace=False))
    ...
    def forward(self, x3_img):
        ...
        return [self.activation(stage3_img+x3_img), self.activation(stage2_img), self.activation(stage1_img)]
